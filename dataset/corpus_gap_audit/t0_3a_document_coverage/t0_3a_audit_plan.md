...
- **Base Commit**: `ef2e8c5c17a753fc133c66272e4ad755ab26e5a4`
- **Frozen Core-Thesis Invariant**: `NO_ACQUISITION`
- **Acquisition Status in T0.3A**: `NO_ACQUISITION` (Coverage audit only; zero acquisition decisions)
...
| `report_era` | `post_2015` | **PRESENT** | `CORE` | Modern corporate reporting era from fiscal year 2015 onward, including... |
